...
from dataset import prepare_npy_collated_loaders, RandomTranslation_batch, \
                    Dataset_npy
from my_tempose import SpatialTemPose_TF
...
class Task:
    ...
    def get_network_architecture(self, model_name, in_channels=2):
        '''
        `model_name`
        - 'SpatialTemPose_TF' (about 2.26M)
        '''
        match model_name:
            case 'SpatialTemPose_TF':
                net = SpatialTemPose_TF(
                    in_dim=in_channels,
...
if __name__ == '__main__':
    ...
    task.get_network_architecture(model_name='SpatialTemPose_TF', in_channels=2)
