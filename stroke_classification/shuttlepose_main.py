...
if __name__ == '__main__':
    ...
    task.prepare_dataloaders(
        root_dir=Path('dataset_3d_npy_collated'),
        pose_style='JnB_bone',
        train_partial=1
    )
    task.get_network_architecture(model_name='ShuttlePose_3_3', in_channels=3)
    task.seek_network_weights(model_info='3d', serial_no=5)
