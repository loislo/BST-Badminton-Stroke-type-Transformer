...
from my_tempose import GTemPose_TF
...
def train_one_epoch(
    ...
    for (human_pose, pos, shuttle), video_len, labels in loader:
        ...
        # human_pose: (n, 2, c, t, v)
        human_pose = human_pose.view(human_pose.shape[0] * human_pose.shape[1], *human_pose.shape[2:])
        human_pose = human_pose.unsqueeze(-1)
        # human_pose: (n*2, c, t, v, m=1)
...
if __name__ == '__main__':
    ...
    task.get_network_architecture(model_name='GTemPose_TF', in_channels=2)
